...
const getRangeSlideShortcuts = () => {
	const ranges = {
		...
		"moz-range-slide-track":
			`group-disabled:bg-opacity-50 bg-[var(--range-track-bg)] h-[--range-track-height] rounded-lg`,
		'ui-input-range': `w-full absolute appearance-none bg-transparent
                     ...
                     range-slider-thumb:bg-[var(--range-thumb-bg)] 
                     ...
                     slider-runnable-track:bg-[var(--range-track-bg)]  
