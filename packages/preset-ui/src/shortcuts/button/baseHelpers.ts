export const genBtnVariantSolidBase = () => {
    return `bg-[--btn-solid-color] hover-[--btn-solid-color:--btn-solid-color-hover] 
...
export const genBtnVariantFlexiBase = () => {
    return `bg-[--btn-flexi-bg] shadow-[0_-1px_0_0px_var(--btn-flexi-shadow-a)_inset,0_0_0_1px_var(--btn-flexi-shadow-b)_inset,0_0.5px_0_1.5px_var(--btn-flexi-shadow-c)_inset] 
     ...
     active:[--btn-flexi-shadow-a:--btn-flexi-shadow-active-a]
     active:[--btn-flexi-shadow-b:--btn-flexi-shadow-active-b]
     active:[--btn-flexi-shadow-c:--btn-flexi-shadow-active-c] 
     focus:[--btn-flexi-shadow-a:--btn-flexi-shadow-active-a]
     focus:[--btn-flexi-shadow-b:--btn-flexi-shadow-active-b]
     focus:[--btn-flexi-shadow-c:--btn-flexi-shadow-active-c] 
     [--btn-focus-outline-color:--btn-flexi-bg-hover]`;
};
